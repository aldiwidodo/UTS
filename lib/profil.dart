      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            itemProfile('Nama', 'Aldi Widodo', CupertinoIcons.person),
            const SizedBox(height: 10),
            itemProfile('Telepon', '081390477777', CupertinoIcons.phone),
            const SizedBox(height: 10),
            itemProfile('Alamat', 'Jl. Gajah Timur Dalam v', CupertinoIcons.location),
            const SizedBox(height: 10),
            itemProfile('Email', 'aldwdd@gmail.com', CupertinoIcons.mail),
            const SizedBox(height: 20,),
            SizedBox(
